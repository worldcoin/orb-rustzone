...
* It has the concept of "storage scopes" which correspond to separate TAs. Each
  TA is merely an instantiation of a single library, to avoid code duplication.

The long term goal is to replace wld-enc-ss and other one-off storage TAs.
